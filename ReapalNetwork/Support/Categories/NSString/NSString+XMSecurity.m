...
@implementation NSString (XMSecurity)
...
//md5加密 32位小写
+ (NSString *)md5_encrypt:(NSString *)content
{
    // MD5 加密密码
...
//-----------------------------------------------------------------------------------
- (NSString*)encrypt_3DES_encodeBase64WithKey:(NSString*)content
{
  NSData * data = [self dataUsingEncoding:NSUTF8StringEncoding];
  NSData * dataout = [NSString doCipherWithData:data key:content operation:kCCEncrypt];
...
// 对一个base64编码的字符串进行解密
//-----------------------------------------------------------------------------------
- (NSString*)decrypt_3DES_decodeBase64WithKey:(NSString*)content
{
  NSData *datain = [NSString decodeBase64WithString:self];
  NSData *dataout = [NSString doCipherWithData:datain key:content operation:kCCDecrypt];
