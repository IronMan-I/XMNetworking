...
/* Configure the default client with a XMNetworking authenticate request resolving class.
 *
...
/* Configure the default client with a XMNetworking common parameters class.
 *
 *
 */
